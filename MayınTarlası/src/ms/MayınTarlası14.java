...
public class MayınTarlası14 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        */
        try {
            ...
            java.util.logging.Logger.getLogger(MayınTarlası14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MayınTarlası14().setVisible(true);
            }
        });
    }
